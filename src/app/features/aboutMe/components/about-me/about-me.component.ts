...
export class AboutMeComponent {
  content: string =
    ...
    'J\'ai débuté ma carrière dans le commerce d\'instruments de musique en exercant pendant 15 ans aux postes de vendeur, chef de rayon, responsable de département et formateur.\n\n'+
    ...
    'Sentant que pour vraiment progresser il fallait me plonger à temps plein dans le dev, j\'ai décidé de quitter mon poste afin de démarrer une formation à plein temps : '+
