...
export class AboutMeComponent {
  content: string =
    ...
    'Sentent que pour vraiment progresser il fallait me plonger à temps plein dans le dev, j\'ai décidé de quitter mon poste afin de démarrer une formation à plein temps : '+
